...
<div class="sidebar">
  <div class="container">
    <div class="sidebar-content">
      ...
      <!-- ! PAGE SELECTOR -->
      <ul class="sidebar-list" style="width: 250px">
        ...
        <li class="sidebar-item <?php if(nav_is_active($page, 'finder')) echo 'active';?> icon-wrapper">
          ...
          <a class="sidebar-link" href="finder.php"><?php echo $lang['finder'] ?></a>
        </li>
        <li class="sidebar-item <?php if(nav_is_active($page, 'settings')) echo 'active';?> icon-wrapper">
          ...
          <a class="sidebar-link" href="settings.php"> <?php echo $lang['settings'] ?> </a>
        </li>
        <li class="sidebar-item icon-wrapper">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
          <a class="sidebar-link" href="logout.php"> <?php echo $lang['logout'] ?> </a>
        </li>
      </ul>
    </div>
  </div>
